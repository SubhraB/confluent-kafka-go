...
across all of our clients (also [confluent-kafka-python](https://github.com/subhrab/confluent-kafka-python)
and [confluent-kafka-dotnet](https://github.com/subhrab/confluent-kafka-dotnet)).
...
```golang
import "github.com/subhrab/confluent-kafka-go/kafka"
```
...
Manual install:
```bash
go get -u github.com/subhrab/confluent-kafka-go/kafka
```
